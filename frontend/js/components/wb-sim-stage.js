      ...
      <div class="shell" role="dialog" aria-modal="true" aria-label="HexBlocks 3D digital twin">
        ...
        <div class="body">
          <div class="viewport-wrap">
            ...
            <div class="legend">
              <span class="applied">actuator state</span>
          ...
          <aside>
            ${selected ? html`
              <div class="inspector">
                ...
                <dl>
                  ...
                  <div class="row"><dt>actuator</dt><dd><pre>${state.actuator ? JSON.stringify(state.actuator, null, 2) : 'no actuator state'}</pre></dd></div>
                </dl>
            ...
            ` : html`
              <div class="inspector-empty">
                SELECT A MODULE<br>
                Inspect live sensor values and returned actuator state.
              </div>
            `}
          </aside>
        </div>
